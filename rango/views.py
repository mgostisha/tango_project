...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        # Is the form valid?
        if form.is_valid():
            # If the form is valid, save the new category to the database
    ...
    # Bad form, form with no details, form not supplied, etc.
...
def restricted(request):
    message = "You're logged in -- you can see this!"
